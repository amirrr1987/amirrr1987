    ...
    <UContainer class="text-center px-4 sm:px-8" :ui="{ constrained: 'max-w-3xl' }">
      <div class="flex flex-col items-center justify-center space-y-6 animate-fade-in-up">
        <svg
          ...
          class="fill-primary-700 dark:fill-primary-500 w-38 h-38 object-contain "
        >
...
-25 79 -29 83 -5 5 -26 -22 -46 -60z"
        ...
        <!-- Name -->
        <h1
          class="text-5xl sm:text-6xl font-extrabold tracking-tight leading-tight bg-gradient-to-r from-primary to-purple-400 bg-clip-text text-transparent"
        >
          Amir Maghami
        </h1>

        <!-- Title -->
        <h2 class="text-xl sm:text-2xl font-medium text-primary">Fullstack Developer</h2>

        <!-- Description -->
        <p class="text-base sm:text-lg text-gray-400">
          I craft beautiful, intuitive, and high-performance web experiences — merging elegant
          design with clean, scalable code to build amazing things for the web.
        </p>
