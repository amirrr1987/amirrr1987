<template>
    <div class=" grid grid-rows-[max-content_1fr_max-content] h-full p-6">

        <img class="w-40 ml-auto" src="@/assets/img/me.png" alt="">
        ...
        <div class="self-end lg:order-1">
            <strong class="text-2xl md:text-3xl mb-3 inline-block text-[#414141]">Hi, I`m</strong>
