    ...
    <UContainer :ui="{ padding: 'py-12 px-4 sm:px-6 lg:px-10' }">
      ...
      <div class="mt-12 space-y-8">
        <div
          ...
          :key="index"
          class="flex gap-6 items-start animate-fade-in-up"
        >
          <!-- Timeline Dot -->
          <div class="relative w-2 h-2 bg-primary rounded-full mt-4">
            <div
              v-if="index !== cvStore.professionalExperience.length - 1"
              class="absolute top-4 bottom-0 left-1/2 -translate-x-1/2 w-0.5 bg-gray-700"
            />
          </div>
          ...
          <div class="flex-1 space-y-2">
            ...
            <p class="font-mono text-primary-500 font-medium">
