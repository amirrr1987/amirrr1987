...
const items = [
  ...
  { label: 'CV Builder case study', to: '/projects/cv-builder', icon: 'i-heroicons-document-magnifying-glass' },
  { label: 'Live — amirmaghami.ir', to: 'https://amirmaghami.ir/', icon: 'i-heroicons-globe-alt' },
  { label: 'Live — Skill Jumper', to: 'https://skill-jumper-amirmaghami.netlify.app/', icon: 'i-heroicons-play' },
  { label: 'Live — Vue Quest', to: 'https://vuequest-amirmaghami.netlify.app/', icon: 'i-heroicons-play' },
  { label: 'Live — Araz Chat', to: 'https://arazapp-amirmaghami.netlify.app/', icon: 'i-heroicons-chat-bubble-left-right' },
