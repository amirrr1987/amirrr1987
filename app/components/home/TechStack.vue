<template>
  <section class="relative z-10 border-t border-white/5 py-12" aria-label="Tech stack">
    <UContainer>
      <p class="label-mono mb-4 text-center" data-reveal>Stack I ship with</p>
      <ul
      ...
      >
        <li
          ...
          class="tech-chip"
        >
          <UIcon :name="tech.icon" class="size-4 text-primary" />
...
const stack = [
  ...
  { label: "Three.js", icon: "i-simple-icons-threedotjs" },
  { label: "GSAP", icon: "i-heroicons-bolt" },
  { label: "Vite", icon: "i-simple-icons-vite" },
];

useGsapScrollReveal({ stagger: 0.04 });
</script>
